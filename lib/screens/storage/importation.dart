...
class _StorageImportationState extends State<StorageImportation> {
  ...
  void initState() {
    ...
    BlocProvider.of<StorageGetImportCubit>(context).getImportation(token: BlocProvider.of<LoginCubit>(context).token, projectId: BlocProvider.of<LoginCubit>(context).projectId);
  }
        ...
        body: BlocConsumer<StorageGetImportCubit, StorageGetImportState>(
          listener: (context, state) {
            if (state is LoadingImportationFailed) {
              Scaffold.of(context).showSnackBar(SnackBar(content: Text("مشکلی هست!")));
            }
          },
          builder: (context, state) {
            ...
            if (state is LoadedImportation) {
              if (state.importations['data'] == null) {
                  ...
                  child: Directionality(
                    ...
                    child: ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          var persianDate = PersianDateTime.fromGregorian(gregorianDateTime: "${state.importations['data'][index]['dateIn'].substring(0, 9)}");
                          return Container(
                            ...
                            child: Stack(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(shape: BoxShape.rectangle, borderRadius: BorderRadius.circular(5), color: Colors.white),
                                  child: Image.asset("assets/images/" + '${state.importations['data'][index]['logo'].toString().toLowerCase()}',
