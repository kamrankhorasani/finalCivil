...
class _StorageStockState extends State<StorageStock> {
  @override
  void initState() {
    BlocProvider.of<StorageGetStockCubit>(context).getStock(token: BlocProvider.of<LoginCubit>(context).token, projectId: BlocProvider.of<LoginCubit>(context).projectId);
    super.initState();
  }
                    ...
                    child: Stack(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Image.asset(
                            "assets/images/" + "${state.stock['data'][index]['logo'].toString().toLowerCase()}",
